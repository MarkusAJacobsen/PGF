...
const navigationOptions = ({ navigation }) => ({
  ...
  headerLeft:
    navigation.isFirstRouteInParent() !== true ? (
      <FontAwesome5
        name={"chevron-left"}
        color="#fff"
        size={20}
  ...
  headerRight: (
    <FontAwesome5
      ...
      light
      onPress={() => {}}
      style={{ marginRight: 15, fontSize: 25, color: "#fff" }}
    />
  ),
  headerTitleStyle: {
...
const RouteConfig = {
  MyGarden: {
    ...
    navigationOptions: {
      tabBarButtonComponent: props => {
        return <NavBarItem {...props} title="My garden" />;
      }
    }
  },
  Growing: {
  ...
  More: {
    ...
    navigationOptions: {
      tabBarButtonComponent: props => <NavBarItem {...props} icon="bars" />
    }
  }
  /*
